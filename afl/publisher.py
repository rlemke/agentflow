...
Publishes AFL source files to the ``afl_sources`` MongoDB collection
...
class SourcePublisher:
    """Publishes AFL source files to MongoDB for namespace-based lookup."""

    def __init__(self, store: MongoStore) -> None:
        self._store = store
        self._parser = AFLParser()
    ...
    def publish(
        ...
        """Publish an AFL source file to MongoDB.
        ...
        Args:
            source_text: AFL source code to publish
