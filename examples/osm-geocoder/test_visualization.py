...
from handlers.map_renderer import (
    HAS_FOLIUM,
    LayerStyle,
    bounds_to_string,
    calculate_bounds,
...
from handlers.visualization_handlers import (
    NAMESPACE,
...
class TestRenderMapHtml:
    ...
    def test_render_creates_html(self, sample_geojson, tmp_path):
        from handlers.map_renderer import render_map_html
...
class TestRenderLayers:
    ...
    def test_render_multiple_layers(self, two_geojson_files, tmp_path):
        from handlers.map_renderer import render_layers
...
class TestVisualizationHandlers:
    ...
    def test_render_map_handler_no_folium(self):
        ...
        from handlers.visualization_handlers import _make_render_map_handler
    ...
    def test_render_layers_handler_empty_layers(self):
        ...
        from handlers.visualization_handlers import _make_render_layers_handler
    ...
    def test_preview_handler_no_folium(self):
        ...
        from handlers.visualization_handlers import _make_preview_map_handler
