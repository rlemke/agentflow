...
Uses mock handlers (no network calls). Run from the repo root:
    ...
    PYTHONPATH=. python examples/osm-geocoder/test_india_cityroutes.py
"""
...
ROUTES = [
    # --- Lucknow routes (9) ---
    {"from": "Lucknow", "to": "Kanpur", "distance_km": 82, "duration_min": 80,
     "waypoints": 130, "via": "NH-2 Lucknow-Agra Expressway"},
    {"from": "Lucknow", "to": "Nagpur", "distance_km": 690, "duration_min": 630,
     "waypoints": 1093, "via": "NH-44 via Allahabad - Jabalpur"},
    {"from": "Lucknow", "to": "Indore", "distance_km": 680, "duration_min": 615,
     "waypoints": 1077, "via": "NH-44 via Jhansi - Lalitpur"},
    {"from": "Lucknow", "to": "Thane", "distance_km": 1390, "duration_min": 1200,
     "waypoints": 2202, "via": "NH-44 via Nagpur - Nashik"},
    {"from": "Lucknow", "to": "Bhopal", "distance_km": 600, "duration_min": 540,
     "waypoints": 950, "via": "NH-44 via Jhansi - Sagar"},
    {"from": "Lucknow", "to": "Visakhapatnam", "distance_km": 1330, "duration_min": 1155,
     "waypoints": 2107, "via": "NH-44/53 via Allahabad - Raipur"},
    {"from": "Lucknow", "to": "Patna", "distance_km": 535, "duration_min": 480,
     "waypoints": 847, "via": "NH-31 via Ayodhya - Gorakhpur"},
    {"from": "Lucknow", "to": "Vadodara", "distance_km": 1010, "duration_min": 870,
     "waypoints": 1600, "via": "NH-44/48 via Jhansi - Bhopal - Indore"},
    {"from": "Lucknow", "to": "Ludhiana", "distance_km": 680, "duration_min": 585,
     "waypoints": 1077, "via": "NH-44 via Delhi - Karnal - Ambala"},
    # --- Kanpur routes (8 remaining) ---
    {"from": "Kanpur", "to": "Nagpur", "distance_km": 640, "duration_min": 585,
     "waypoints": 1014, "via": "NH-44 via Sagar - Jabalpur"},
    {"from": "Kanpur", "to": "Indore", "distance_km": 620, "duration_min": 555,
     "waypoints": 982, "via": "NH via Jhansi - Lalitpur - Dewas"},
    {"from": "Kanpur", "to": "Thane", "distance_km": 1340, "duration_min": 1155,
     "waypoints": 2123, "via": "NH-44 via Nagpur - Nashik"},
    {"from": "Kanpur", "to": "Bhopal", "distance_km": 530, "duration_min": 480,
     "waypoints": 840, "via": "NH-44 via Jhansi - Sagar"},
    {"from": "Kanpur", "to": "Visakhapatnam", "distance_km": 1270, "duration_min": 1110,
     "waypoints": 2012, "via": "NH via Allahabad - Raipur - Rourkela"},
    {"from": "Kanpur", "to": "Patna", "distance_km": 575, "duration_min": 525,
     "waypoints": 911, "via": "NH-2 via Allahabad - Varanasi"},
    {"from": "Kanpur", "to": "Vadodara", "distance_km": 955, "duration_min": 825,
     "waypoints": 1513, "via": "NH via Jhansi - Bhopal - Indore"},
    {"from": "Kanpur", "to": "Ludhiana", "distance_km": 740, "duration_min": 645,
     "waypoints": 1172, "via": "NH-2 via Agra - Delhi - Ambala"},
    # --- Nagpur routes (7 remaining) ---
    {"from": "Nagpur", "to": "Indore", "distance_km": 470, "duration_min": 435,
     "waypoints": 745, "via": "NH-47 via Betul - Khandwa"},
    {"from": "Nagpur", "to": "Thane", "distance_km": 800, "duration_min": 690,
     "waypoints": 1267, "via": "NH-44 via Amravati - Nashik"},
    {"from": "Nagpur", "to": "Bhopal", "distance_km": 350, "duration_min": 315,
     "waypoints": 554, "via": "NH-44 via Seoni - Chhindwara"},
    {"from": "Nagpur", "to": "Visakhapatnam", "distance_km": 700, "duration_min": 630,
     "waypoints": 1109, "via": "NH-53 via Raipur - Rourkela - Bhubaneswar"},
    {"from": "Nagpur", "to": "Patna", "distance_km": 1010, "duration_min": 885,
     "waypoints": 1600, "via": "NH via Raipur - Ranchi - Gaya"},
    {"from": "Nagpur", "to": "Vadodara", "distance_km": 750, "duration_min": 660,
     "waypoints": 1188, "via": "NH-48 via Dhule - Surat"},
    {"from": "Nagpur", "to": "Ludhiana", "distance_km": 1350, "duration_min": 1170,
     "waypoints": 2139, "via": "NH-44 via Bhopal - Jhansi - Agra - Delhi"},
    # --- Indore routes (6 remaining) ---
    {"from": "Indore", "to": "Thane", "distance_km": 590, "duration_min": 510,
     "waypoints": 935, "via": "NH-48 via Dhule - Nashik"},
    {"from": "Indore", "to": "Bhopal", "distance_km": 195, "duration_min": 180,
     "waypoints": 309, "via": "NH-46 via Dewas"},
    {"from": "Indore", "to": "Visakhapatnam", "distance_km": 1150, "duration_min": 1005,
     "waypoints": 1822, "via": "NH via Bhopal - Nagpur - Raipur"},
    {"from": "Indore", "to": "Patna", "distance_km": 1180, "duration_min": 1020,
     "waypoints": 1869, "via": "NH via Bhopal - Jhansi - Allahabad"},
    {"from": "Indore", "to": "Vadodara", "distance_km": 310, "duration_min": 270,
     "waypoints": 491, "via": "NH-48 via Godhra"},
    {"from": "Indore", "to": "Ludhiana", "distance_km": 1050, "duration_min": 915,
     "waypoints": 1663, "via": "NH-48 via Udaipur - Jaipur - Delhi"},
    # --- Thane routes (5 remaining) ---
    {"from": "Thane", "to": "Bhopal", "distance_km": 780, "duration_min": 675,
     "waypoints": 1235, "via": "NH-48/44 via Nashik - Dhule"},
    {"from": "Thane", "to": "Visakhapatnam", "distance_km": 1100, "duration_min": 945,
     "waypoints": 1742, "via": "NH-44 via Pune - Hyderabad - Vijayawada"},
    {"from": "Thane", "to": "Patna", "distance_km": 1740, "duration_min": 1500,
     "waypoints": 2756, "via": "NH via Nashik - Nagpur - Jabalpur - Allahabad"},
    {"from": "Thane", "to": "Vadodara", "distance_km": 400, "duration_min": 345,
     "waypoints": 634, "via": "NH-48 via Surat"},
    {"from": "Thane", "to": "Ludhiana", "distance_km": 1560, "duration_min": 1350,
     "waypoints": 2471, "via": "NH-48 via Surat - Udaipur - Jaipur - Delhi"},
    # --- Bhopal routes (4 remaining) ---
    {"from": "Bhopal", "to": "Visakhapatnam", "distance_km": 1010, "duration_min": 885,
     "waypoints": 1600, "via": "NH via Nagpur - Raipur - Rourkela"},
    {"from": "Bhopal", "to": "Patna", "distance_km": 955, "duration_min": 825,
     "waypoints": 1513, "via": "NH-44 via Jhansi - Allahabad - Varanasi"},
    {"from": "Bhopal", "to": "Vadodara", "distance_km": 500, "duration_min": 435,
     "waypoints": 792, "via": "NH-46/48 via Indore - Godhra"},
    {"from": "Bhopal", "to": "Ludhiana", "distance_km": 1100, "duration_min": 945,
     "waypoints": 1742, "via": "NH-44 via Jhansi - Agra - Delhi - Ambala"},
    # --- Visakhapatnam routes (3 remaining) ---
    {"from": "Visakhapatnam", "to": "Patna", "distance_km": 1310, "duration_min": 1140,
     "waypoints": 2075, "via": "NH-53/33 via Raipur - Ranchi - Gaya"},
    {"from": "Visakhapatnam", "to": "Vadodara", "distance_km": 1380, "duration_min": 1200,
     "waypoints": 2186, "via": "NH via Hyderabad - Nagpur - Dhule"},
    {"from": "Visakhapatnam", "to": "Ludhiana", "distance_km": 1990, "duration_min": 1725,
     "waypoints": 3152, "via": "NH via Raipur - Nagpur - Bhopal - Delhi"},
    # --- Patna routes (2 remaining) ---
    {"from": "Patna", "to": "Vadodara", "distance_km": 1430, "duration_min": 1230,
     "waypoints": 2265, "via": "NH via Varanasi - Allahabad - Bhopal - Indore"},
    {"from": "Patna", "to": "Ludhiana", "distance_km": 1190, "duration_min": 1020,
     "waypoints": 1885, "via": "NH via Varanasi - Lucknow - Delhi"},
    # --- Vadodara routes (1 remaining) ---
    {"from": "Vadodara", "to": "Ludhiana", "distance_km": 1060, "duration_min": 915,
     "waypoints": 1679, "via": "NH-48 via Ahmedabad - Udaipur - Jaipur - Delhi"},
]
...
MOCK_HANDLERS = {
    ...
    "ExtractPlacesWithPopulation": lambda p: {
        "result": {
            ...
            "feature_count": len([c for c in INDIAN_CITIES
    ...
    "FilterByPopulationRange": lambda p: {
        "result": {
            ...
            "original_count": len([c for c in INDIAN_CITIES
                                   if c["population"] >= p.get("min_population", 0)]),
            "place_type": "city",
            "min_population": p.get("min_population", 0),
...
def main() -> None:
    ...
    # 1. Execute workflow
    print('Executing: CityRouteMapByRegion(region="India", '
    ...
    print(f"\n{'=' * 80}")
    print(f"RESULTS: Indian Cities {MIN_POP/1e6:.1f}-{MAX_POP/1e6:.0f}M - All-Pairs Driving Routes")
    print(f"{'=' * 80}")
    ...
    abbrev = {"Lucknow": "LKO", "Kanpur": "KNP", "Nagpur": "NGP", "Indore": "IDR",
              "Thane": "THN", "Bhopal": "BPL", "Visakhapatnam": "VZG",
              "Patna": "PAT", "Vadodara": "BRC", "Ludhiana": "LDH"}
    ...
    for route in sorted_routes[:10]:
        ...
        print(f"    {label:<34} {route['distance_km']:>7,} km  "
    ...
    print(f"    {'Average':<34} {AVG_DISTANCE:>7,} km  "
    ...
    for city_name in city_names:
        ...
        print(f"    {city_name:.<20} {len(city_routes)} routes, {total_km:>6,} km total  "
    ...
    state_names = {"UP": "Uttar Pradesh", "MH": "Maharashtra", "MP": "Madhya Pradesh",
                   "GJ": "Gujarat", "AP": "Andhra Pradesh", "BR": "Bihar",
                   "PB": "Punjab"}
    ...
    for state, cities in sorted(multi_city_states.items(), key=lambda x: len(x[1]), reverse=True):
        ...
        intra = [r for r in ROUTES
                 if r["from"] in city_names_in_state and r["to"] in city_names_in_state]
        if intra:
            shortest = min(intra, key=lambda r: r["distance_km"])
            print(f"      Shortest intra-state: {shortest['from']} -> {shortest['to']} "
    ...
    print(f"\n  Excluded cities:")
    for c in too_big:
        print(f"    {c['name']:.<20} {c['population']:>10,}  {c['state']:<4} (above {MAX_POP/1e6:.0f}M)")
    for c in sorted(too_small, key=lambda x: x["population"], reverse=True)[:5]:
        print(f"    {c['name']:.<20} {c['population']:>10,}  {c['state']:<4} (below {MIN_POP/1e6:.1f}M)")
    if len(too_small) > 5:
