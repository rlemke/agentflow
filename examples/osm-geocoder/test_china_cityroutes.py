...
This test uses mock handlers (no network calls). Run from the repo root:
    ...
    PYTHONPATH=. python examples/osm-geocoder/test_china_cityroutes.py
"""
...
CHINESE_CITIES = [
    ...
    {"name": "Chongqing", "province": "CQ", "population": 16_380_000, "lat": 29.563, "lon": 106.552},
    {"name": "Guangzhou", "province": "GD", "population": 15_310_000, "lat": 23.130, "lon": 113.264},
...
ROUTES = [
    # --- Kunming routes (11) ---
    {"from": "Kunming", "to": "Dalian", "distance_km": 3400, "duration_min": 2100,
     "waypoints": 5382, "via": "G5/G65 via Chongqing - Xi'an - Beijing - Shenyang"},
    {"from": "Kunming", "to": "Jinan", "distance_km": 2600, "duration_min": 1620,
     "waypoints": 4117, "via": "G60/G56 via Guiyang - Changsha - Wuhan"},
    {"from": "Kunming", "to": "Qingdao", "distance_km": 2900, "duration_min": 1800,
     "waypoints": 4593, "via": "G56 via Guiyang - Changsha - Hefei"},
    {"from": "Kunming", "to": "Hefei", "distance_km": 2200, "duration_min": 1380,
     "waypoints": 3484, "via": "G56 via Guiyang - Changsha - Nanchang"},
    {"from": "Kunming", "to": "Fuzhou", "distance_km": 2300, "duration_min": 1440,
     "waypoints": 3642, "via": "G56/G70 via Guiyang - Changsha - Nanchang"},
    {"from": "Kunming", "to": "Nanning", "distance_km": 830, "duration_min": 540,
     "waypoints": 1314, "via": "G80 Guangkun Expressway"},
    {"from": "Kunming", "to": "Changchun", "distance_km": 3900, "duration_min": 2400,
     "waypoints": 6174, "via": "G5 via Chongqing - Xi'an - Beijing - Shenyang"},
    {"from": "Kunming", "to": "Wuxi", "distance_km": 2400, "duration_min": 1500,
     "waypoints": 3800, "via": "G60 via Guiyang - Changsha - Nanchang"},
    {"from": "Kunming", "to": "Nanchang", "distance_km": 1900, "duration_min": 1200,
     "waypoints": 3009, "via": "G60/G56 via Guiyang - Changsha"},
    {"from": "Kunming", "to": "Guiyang", "distance_km": 500, "duration_min": 300,
     "waypoints": 792, "via": "G60 Hukun Expressway"},
    {"from": "Kunming", "to": "Taiyuan", "distance_km": 2500, "duration_min": 1560,
     "waypoints": 3958, "via": "G5 via Chongqing - Xi'an"},
    # --- Dalian routes (10 remaining) ---
    {"from": "Dalian", "to": "Jinan", "distance_km": 970, "duration_min": 600,
     "waypoints": 1536, "via": "G15 via Yantai ferry or G1/G2 via Shenyang - Beijing"},
    {"from": "Dalian", "to": "Qingdao", "distance_km": 1200, "duration_min": 780,
     "waypoints": 1900, "via": "G15 Shenhai Expressway coastal route"},
    {"from": "Dalian", "to": "Hefei", "distance_km": 1550, "duration_min": 960,
     "waypoints": 2454, "via": "G1/G2/G3 via Shenyang - Beijing - Jinan"},
    {"from": "Dalian", "to": "Fuzhou", "distance_km": 2200, "duration_min": 1380,
     "waypoints": 3484, "via": "G1/G2 via Shenyang - Beijing - Hefei - Nanchang"},
    {"from": "Dalian", "to": "Nanning", "distance_km": 3200, "duration_min": 1980,
     "waypoints": 5067, "via": "G1/G4 via Shenyang - Beijing - Wuhan - Changsha"},
    {"from": "Dalian", "to": "Changchun", "distance_km": 700, "duration_min": 420,
     "waypoints": 1108, "via": "G1 Jingha Expressway via Shenyang"},
    {"from": "Dalian", "to": "Wuxi", "distance_km": 1700, "duration_min": 1080,
     "waypoints": 2691, "via": "G1/G2 via Shenyang - Beijing - Jinan"},
    {"from": "Dalian", "to": "Nanchang", "distance_km": 2000, "duration_min": 1260,
     "waypoints": 3167, "via": "G1/G2/G35 via Shenyang - Beijing - Hefei"},
    {"from": "Dalian", "to": "Guiyang", "distance_km": 3100, "duration_min": 1920,
     "waypoints": 4908, "via": "G1/G4 via Shenyang - Beijing - Wuhan - Changsha"},
    {"from": "Dalian", "to": "Taiyuan", "distance_km": 1200, "duration_min": 720,
     "waypoints": 1900, "via": "G1/G5 via Shenyang - Beijing"},
    # --- Jinan routes (9 remaining) ---
    {"from": "Jinan", "to": "Qingdao", "distance_km": 370, "duration_min": 240,
     "waypoints": 586, "via": "G20 Qingyin Expressway"},
    {"from": "Jinan", "to": "Hefei", "distance_km": 600, "duration_min": 360,
     "waypoints": 950, "via": "G3 Jingtai Expressway"},
    {"from": "Jinan", "to": "Fuzhou", "distance_km": 1300, "duration_min": 840,
     "waypoints": 2059, "via": "G3/G70 via Hefei - Nanchang"},
    {"from": "Jinan", "to": "Nanning", "distance_km": 2200, "duration_min": 1380,
     "waypoints": 3484, "via": "G35/G4 via Hefei - Changsha - Guiyang"},
    {"from": "Jinan", "to": "Changchun", "distance_km": 1500, "duration_min": 900,
     "waypoints": 2375, "via": "G2/G1 via Beijing - Shenyang"},
    {"from": "Jinan", "to": "Wuxi", "distance_km": 700, "duration_min": 420,
     "waypoints": 1108, "via": "G2 Jinghu Expressway"},
    {"from": "Jinan", "to": "Nanchang", "distance_km": 1000, "duration_min": 600,
     "waypoints": 1583, "via": "G35 Jiguang Expressway via Hefei"},
    {"from": "Jinan", "to": "Guiyang", "distance_km": 1900, "duration_min": 1200,
     "waypoints": 3009, "via": "G35/G60 via Hefei - Changsha"},
    {"from": "Jinan", "to": "Taiyuan", "distance_km": 530, "duration_min": 330,
     "waypoints": 839, "via": "G20/G5 via Shijiazhuang"},
    # --- Qingdao routes (8 remaining) ---
    {"from": "Qingdao", "to": "Hefei", "distance_km": 850, "duration_min": 540,
     "waypoints": 1346, "via": "G15/G3 via Lianyungang"},
    {"from": "Qingdao", "to": "Fuzhou", "distance_km": 1400, "duration_min": 900,
     "waypoints": 2217, "via": "G15 Shenhai Expressway coastal route"},
    {"from": "Qingdao", "to": "Nanning", "distance_km": 2500, "duration_min": 1560,
     "waypoints": 3958, "via": "G15/G4 via Hefei - Changsha - Guiyang"},
    {"from": "Qingdao", "to": "Changchun", "distance_km": 1700, "duration_min": 1020,
     "waypoints": 2691, "via": "G20/G2/G1 via Jinan - Beijing - Shenyang"},
    {"from": "Qingdao", "to": "Wuxi", "distance_km": 900, "duration_min": 540,
     "waypoints": 1425, "via": "G15 via Lianyungang - Yancheng"},
    {"from": "Qingdao", "to": "Nanchang", "distance_km": 1300, "duration_min": 780,
     "waypoints": 2059, "via": "G15/G35 via Hefei"},
    {"from": "Qingdao", "to": "Guiyang", "distance_km": 2200, "duration_min": 1380,
     "waypoints": 3484, "via": "G20/G35/G60 via Hefei - Changsha"},
    {"from": "Qingdao", "to": "Taiyuan", "distance_km": 900, "duration_min": 540,
     "waypoints": 1425, "via": "G20/G5 via Jinan - Shijiazhuang"},
    # --- Hefei routes (7 remaining) ---
    {"from": "Hefei", "to": "Fuzhou", "distance_km": 800, "duration_min": 480,
     "waypoints": 1267, "via": "G3/G70 via Nanchang"},
    {"from": "Hefei", "to": "Nanning", "distance_km": 1600, "duration_min": 1020,
     "waypoints": 2533, "via": "G35/G4 via Changsha - Guiyang"},
    {"from": "Hefei", "to": "Changchun", "distance_km": 2050, "duration_min": 1260,
     "waypoints": 3246, "via": "G3/G2/G1 via Jinan - Beijing - Shenyang"},
    {"from": "Hefei", "to": "Wuxi", "distance_km": 290, "duration_min": 180,
     "waypoints": 459, "via": "G40 Hushan Expressway"},
    {"from": "Hefei", "to": "Nanchang", "distance_km": 460, "duration_min": 300,
     "waypoints": 728, "via": "G35 Jiguang Expressway"},
    {"from": "Hefei", "to": "Guiyang", "distance_km": 1500, "duration_min": 900,
     "waypoints": 2375, "via": "G50/G56 via Changsha"},
    {"from": "Hefei", "to": "Taiyuan", "distance_km": 1050, "duration_min": 660,
     "waypoints": 1663, "via": "G3/G5 via Jinan - Shijiazhuang"},
    # --- Fuzhou routes (6 remaining) ---
    {"from": "Fuzhou", "to": "Nanning", "distance_km": 1400, "duration_min": 900,
     "waypoints": 2217, "via": "G72/G80 via Guangzhou"},
    {"from": "Fuzhou", "to": "Changchun", "distance_km": 2800, "duration_min": 1740,
     "waypoints": 4433, "via": "G70/G3/G2/G1 via Nanchang - Hefei - Jinan - Beijing"},
    {"from": "Fuzhou", "to": "Wuxi", "distance_km": 900, "duration_min": 540,
     "waypoints": 1425, "via": "G15 Shenhai Expressway via Wenzhou"},
    {"from": "Fuzhou", "to": "Nanchang", "distance_km": 550, "duration_min": 360,
     "waypoints": 871, "via": "G70 Fuyin Expressway"},
    {"from": "Fuzhou", "to": "Guiyang", "distance_km": 1700, "duration_min": 1080,
     "waypoints": 2691, "via": "G70/G56 via Nanchang - Changsha"},
    {"from": "Fuzhou", "to": "Taiyuan", "distance_km": 1800, "duration_min": 1140,
     "waypoints": 2850, "via": "G70/G3/G5 via Nanchang - Hefei - Jinan"},
    # --- Nanning routes (5 remaining) ---
    {"from": "Nanning", "to": "Changchun", "distance_km": 3700, "duration_min": 2280,
     "waypoints": 5858, "via": "G75/G5 via Guiyang - Chongqing - Xi'an - Beijing - Shenyang"},
    {"from": "Nanning", "to": "Wuxi", "distance_km": 2000, "duration_min": 1260,
     "waypoints": 3167, "via": "G75/G56 via Guiyang - Changsha - Nanchang"},
    {"from": "Nanning", "to": "Nanchang", "distance_km": 1400, "duration_min": 900,
     "waypoints": 2217, "via": "G72/G4 via Guangzhou - Changsha"},
    {"from": "Nanning", "to": "Guiyang", "distance_km": 490, "duration_min": 300,
     "waypoints": 776, "via": "G75 Lanhai Expressway"},
    {"from": "Nanning", "to": "Taiyuan", "distance_km": 2600, "duration_min": 1620,
     "waypoints": 4117, "via": "G75/G5 via Guiyang - Chongqing - Xi'an"},
    # --- Changchun routes (4 remaining) ---
    {"from": "Changchun", "to": "Wuxi", "distance_km": 2100, "duration_min": 1320,
     "waypoints": 3325, "via": "G1/G2 via Shenyang - Beijing - Jinan"},
    {"from": "Changchun", "to": "Nanchang", "distance_km": 2500, "duration_min": 1560,
     "waypoints": 3958, "via": "G1/G2/G35 via Shenyang - Beijing - Hefei"},
    {"from": "Changchun", "to": "Guiyang", "distance_km": 3500, "duration_min": 2160,
     "waypoints": 5542, "via": "G1/G4 via Shenyang - Beijing - Wuhan - Changsha"},
    {"from": "Changchun", "to": "Taiyuan", "distance_km": 1700, "duration_min": 1020,
     "waypoints": 2691, "via": "G1/G5 via Shenyang - Beijing"},
    # --- Wuxi routes (3 remaining) ---
    {"from": "Wuxi", "to": "Nanchang", "distance_km": 620, "duration_min": 360,
     "waypoints": 982, "via": "G56 Hangrui Expressway"},
    {"from": "Wuxi", "to": "Guiyang", "distance_km": 1700, "duration_min": 1080,
     "waypoints": 2691, "via": "G56/G60 via Nanchang - Changsha"},
    {"from": "Wuxi", "to": "Taiyuan", "distance_km": 1150, "duration_min": 720,
     "waypoints": 1821, "via": "G2/G5 via Jinan - Shijiazhuang"},
    # --- Nanchang routes (2 remaining) ---
    {"from": "Nanchang", "to": "Guiyang", "distance_km": 1200, "duration_min": 720,
     "waypoints": 1900, "via": "G56/G60 via Changsha"},
    {"from": "Nanchang", "to": "Taiyuan", "distance_km": 1400, "duration_min": 840,
     "waypoints": 2217, "via": "G35/G5 via Hefei - Jinan"},
    # --- Guiyang routes (1 remaining) ---
    {"from": "Guiyang", "to": "Taiyuan", "distance_km": 2000, "duration_min": 1260,
     "waypoints": 3167, "via": "G60/G5 via Chongqing - Xi'an"},
]
...
MOCK_HANDLERS = {
    ...
    "ExtractPlacesWithPopulation": lambda p: {
        "result": {
            ...
            "feature_count": len([c for c in CHINESE_CITIES
    ...
    "FilterByPopulationRange": lambda p: {
        "result": {
            ...
            "original_count": len([c for c in CHINESE_CITIES
                                   if c["population"] >= p.get("min_population", 0)]),
            "place_type": "city",
            "min_population": p.get("min_population", 0),
...
def main() -> None:
    ...
    # 1. Execute workflow
    print('Executing: CityRouteMapByRegion(region="China", '
    ...
    print(f"\n{'=' * 85}")
    print(f"RESULTS: Chinese Cities {MIN_POP//1_000_000}-{MAX_POP//1_000_000}M - All-Pairs Driving Routes")
    print(f"{'=' * 85}")
    ...
    abbrev = {"Kunming": "KMG", "Dalian": "DLC", "Jinan": "TNA", "Qingdao": "TAO",
              "Hefei": "HFE", "Fuzhou": "FOC", "Nanning": "NNG", "Changchun": "CGQ",
              "Wuxi": "WUX", "Nanchang": "KHN", "Guiyang": "KWE", "Taiyuan": "TYN"}
    col_w = 9
    print(f"\n  Distance matrix (km):")
    ...
    for route in sorted_routes[:10]:
        ...
        print(f"    {label:<30} {route['distance_km']:>7,} km  "
    ...
    print(f"    {'Average':<30} {AVG_DISTANCE:>7,} km  "
    ...
    for city_name in city_names:
        ...
        print(f"    {city_name:.<14} {len(city_routes):>2} routes, {total_km:>6,} km total  "
    ...
    province_names = {"YN": "Yunnan", "LN": "Liaoning", "SD": "Shandong", "AH": "Anhui",
                      "FJ": "Fujian", "GX": "Guangxi", "JL": "Jilin", "JS": "Jiangsu",
                      "JX": "Jiangxi", "GZ": "Guizhou", "SX": "Shanxi"}

    if multi_city_provinces:
        print(f"\n  Geographic clusters (provinces with 2+ cities in range):")
        for prov, cities in sorted(multi_city_provinces.items(), key=lambda x: len(x[1]), reverse=True):
    ...
    print(f"\n  Excluded cities:")
    for c in too_big:
        print(f"    {c['name']:.<14} {c['population']:>10,}  {c['province']:<4} (above {MAX_POP//1_000_000}M)")
    for c in sorted(too_small, key=lambda x: x["population"], reverse=True)[:5]:
        print(f"    {c['name']:.<14} {c['population']:>10,}  {c['province']:<4} (below {MIN_POP//1_000_000}M)")
    if len(too_small) > 5:
