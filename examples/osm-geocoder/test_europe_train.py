...
Uses mock handlers (no network calls). Run from the repo root:
    ...
    PYTHONPATH=. python examples/osm-geocoder/test_europe_train.py
"""
...
def main() -> None:
    ...
    print('Executing: RouteMapByRegion(region="Switzerland", route_type="train", min_elevation_ft=3000)')
