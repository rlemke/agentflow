...
from handlers.tiger_downloader import (
...
from handlers.tiger_handlers import (
    NAMESPACE_DISTRICTS,
...
class TestTigerHandlers:
    ...
    def test_congressional_handler_mock(self):
        ...
        from handlers.tiger_handlers import _make_congressional_handler
    ...
    def test_state_senate_handler_mock(self):
        ...
        from handlers.tiger_handlers import _make_state_senate_handler
    ...
    def test_handler_error_returns_empty_cache(self):
        ...
        from handlers.tiger_handlers import _make_voting_precincts_handler
...
class TestFilterDistrictsHandler:
    ...
    def test_filter_by_name(self, sample_districts_geojson, tmp_path):
        ...
        from handlers.tiger_handlers import _make_filter_districts_handler
...
class TestStateFIPSHandler:
    ...
    def test_resolve_california(self):
        from handlers.tiger_handlers import _make_state_fips_handler
