...
class TestCompilation:
    ...
    def test_foreach_present(self, parsed_ast):
        ...
        has_foreach = any(
            ...
            for block in agent_focused.body
        )
        assert has_foreach
...
class TestAgentIntegration:
    def test_tool_registry_dispatches_all_handlers(self):
        ...
        tool_names = [
            "InitiateRound", "AssignPositions", "RefineArgument",
            "ChallengeArgument", "ScoreRound", "EvaluateConvergence",
            "SummarizeRound", "DeclareOutcome",
        ]
