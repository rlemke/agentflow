"""Tests for tool-use-agent handlers and AFL compilation."""
...
class TestCompilation:
    ...
    def parsed_ast(self):
        ...
        afl_path = os.path.join(os.path.dirname(__file__), "..", "afl", "toolbox.afl")
...
class TestAgentIntegration:
    def test_tool_registry_dispatches_all_handlers(self):
        ...
        tool_names = [
            "PlanToolUse", "SelectNextTool", "WebSearch",
            "DeepSearch", "Calculate", "ExecuteCode",
            "SynthesizeResults", "FormatAnswer",
        ]
