...
2. **Per-component specs** — co-located with the source. Each tool,
   ...
   ```
   https://github.com/rlemke/fwh_osm/blob/main/src/osm_geocoder/tools/_osm_tools/
...
|---|---|---|
| [pbf_download](https://github.com/rlemke/fwh_osm/blob/main/src/osm_geocoder/tools/_osm_tools/pbf_download.agent-spec.yaml) | external repo | Geofabrik PBF downloader — MD5 verification, manifest-based caching, thread-safe per region. Pilot spec demonstrating the format on a concrete tool. |
